...
namespace App\Models {
   ...
   * @property tinyint(1) $segunda
   * @property tinyint(1) $primera
   * @property string $ente
   * @property bigint(20) unsigned|null $subcategoria_id
   * @property bigint(20) unsigned|null $categoria_id
   * @property bigint(20) unsigned|null $tipo_id
   * @property bigint(20) unsigned|null $estatus_id
   * @property string $nombre
   ...
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereNombre($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereEstatusId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereTipoId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereCategoriaId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereSubcategoriaId($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereEnte($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta wherePrimera($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereSegunda($value)
   * @method static \Illuminate\Database\Eloquent\Builder|Consulta whereCodigoente($value)
